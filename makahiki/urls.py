...
urlpatterns = patterns('',
                       ...
                       url(r'^actions/$', "pages.views.index",
                           name="actions_index"),
                       url(r'^profile/$', "pages.views.index",
                           name="profile_index"),
                       url(r'^energy/$', "pages.views.index",
                           name="energy_index"),
                       url(r'^news/$', "pages.views.index", name="news_index"),
                       url(r'^prizes/$', "pages.views.index",
                           name="prizes_index"),
                       url(r'^canopy/$', 'pages.views.index',
                           name="canopy_index"),

                       # system level
                       url(r'^log/', include('managers.log_mgr.urls')),
                       url(r'^help/', include('managers.help_mgr.urls')),
                       url(r'^account/login/$', 'managers.auth_mgr.views'
                                                '.login',
                           name='auth_login'),
                       url(r'^account/cas/login/$',
                           'lib.django_cas.views.login'),
                       url(r'^account/cas/logout/$',
                           'lib.django_cas.views.logout'),
                       url(r'^avatar/', include('lib.avatar.urls')),
    (r'^admin/login-as/(?P<user_id>\d+)/$', 'managers.auth_mgr.views'\
                                            '.login_as'),
    (r'^admin/doc/', include('django.contrib.admindocs.urls')),
    (r'^admin/', include(admin.site.urls)),

                       url(r'^landing/$', direct_to_template,
                               {'template': 'landing.html'}, name='landing'),
                       url(r'^restricted/$', direct_to_template,
                               {"template": 'restricted.html'},
                           name="restricted"),
                       url(r'^about/$', direct_to_template,
                               {'template': 'about.html'}, name='about'),
                       url(r'^browser-check/$', direct_to_template,
                               {'template': 'browser_check.html'},
                           name='browser_check'),
