...
from gamelets.prizes import POINTS_PER_TICKET
from services.cache_mgr.utils import invalidate_info_bar_cache
...
class Profile(models.Model):
  ...
  def _last_submitted_before(self, submission_date):
    ...
    from gamelets.smartgrid_game.models import CommitmentMember, ActivityMember
