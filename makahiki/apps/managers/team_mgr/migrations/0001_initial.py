...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('team_mgr_group')

        # Deleting model 'Team'
        db.delete_table('team_mgr_team')
