...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.theme'
        db.alter_column('player_mgr_profile', 'theme', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.theme'
        db.alter_column('player_mgr_profile', 'theme', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 2, 12, 31, 48, 142927)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 2, 12, 31, 48, 142748)'}),
