...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('challenge_mgr_roundsetting', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RoundSetting', fields ['name']
        db.delete_unique('challenge_mgr_roundsetting', ['name'])
    ...
    models = {
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 16, 30, 58, 987997)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 16, 30, 58, 987936)'})
        },
