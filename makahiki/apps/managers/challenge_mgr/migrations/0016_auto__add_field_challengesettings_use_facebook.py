...
class Migration(SchemaMigration):
    ...
    models = {
        'challenge_mgr.challengesettings': {
            ...
            'use_facebook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 14, 26, 44, 790137)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 14, 26, 44, 790081)'})
        },
