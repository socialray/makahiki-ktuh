...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChallengeSetting.site_domain'
        db.delete_column('challenge_mgr_challengesetting', 'site_domain')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ChallengeSetting.site_domain'
        db.add_column('challenge_mgr_challengesetting', 'site_domain', self.gf('django.db.models.fields.CharField')(default='localhost', max_length=100), keep_default=False)
    ...
    models = {
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 8, 1, 40, 711606)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 8, 1, 40, 711564)'})
        },
