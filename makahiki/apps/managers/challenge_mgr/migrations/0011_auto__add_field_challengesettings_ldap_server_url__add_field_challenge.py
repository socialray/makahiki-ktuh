...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChallengeSettings.ldap_server_url'
        db.add_column('challenge_mgr_challengesettings', 'ldap_server_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'ChallengeSettings.ldap_search_base'
        db.add_column('challenge_mgr_challengesettings', 'ldap_search_base', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'ChallengeSettings.cas_server_url'
        db.alter_column('challenge_mgr_challengesettings', 'cas_server_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'ChallengeSettings.ldap_server_url'
        db.delete_column('challenge_mgr_challengesettings', 'ldap_server_url')

        # Deleting field 'ChallengeSettings.ldap_search_base'
        db.delete_column('challenge_mgr_challengesettings', 'ldap_search_base')

        # Changing field 'ChallengeSettings.cas_server_url'
        db.alter_column('challenge_mgr_challengesettings', 'cas_server_url', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 12, 40, 48, 726269)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 7, 12, 40, 48, 726208)'})
        },
