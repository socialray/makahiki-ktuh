...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sponsor.challenge'
        db.add_column('challenge_mgr_sponsor', 'challenge', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenge_mgr.ChallengeSettings']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sponsor.challenge'
        db.delete_column('challenge_mgr_sponsor', 'challenge_id')
    ...
    models = {
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 14, 34, 53, 733725)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 3, 14, 34, 53, 733671)'})
        },
