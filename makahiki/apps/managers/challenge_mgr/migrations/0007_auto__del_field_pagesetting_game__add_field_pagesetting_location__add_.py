...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PageSetting', fields ['widget', 'game', 'page']
        db.delete_unique('challenge_mgr_pagesetting', ['widget', 'game_id', 'page_id'])

        # Deleting field 'PageSetting.game'
        db.delete_column('challenge_mgr_pagesetting', 'game_id')

        # Adding field 'PageSetting.location'
        db.add_column('challenge_mgr_pagesetting', 'location', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'PageSetting.priority'
        db.add_column('challenge_mgr_pagesetting', 'priority', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding unique constraint on 'PageSetting', fields ['widget', 'page']
        db.create_unique('challenge_mgr_pagesetting', ['widget', 'page_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PageSetting', fields ['widget', 'page']
        db.delete_unique('challenge_mgr_pagesetting', ['widget', 'page_id'])

        # Adding field 'PageSetting.game'
        db.add_column('challenge_mgr_pagesetting', 'game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenge_mgr.GameInfo'], null=True, blank=True), keep_default=False)

        # Deleting field 'PageSetting.location'
        db.delete_column('challenge_mgr_pagesetting', 'location')

        # Deleting field 'PageSetting.priority'
        db.delete_column('challenge_mgr_pagesetting', 'priority')

        # Adding unique constraint on 'PageSetting', fields ['widget', 'game', 'page']
        db.create_unique('challenge_mgr_pagesetting', ['widget', 'game_id', 'page_id'])
    ...
    models = {
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 10, 9, 11, 368520)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 27, 10, 9, 11, 368467)'})
        },
