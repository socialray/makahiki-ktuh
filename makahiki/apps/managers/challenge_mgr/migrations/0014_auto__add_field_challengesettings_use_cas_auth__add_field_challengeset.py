...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChallengeSettings.use_cas_auth'
        db.add_column('challenge_mgr_challengesettings', 'use_cas_auth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChallengeSettings.use_ldap_auth'
        db.add_column('challenge_mgr_challengesettings', 'use_ldap_auth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChallengeSettings.use_internal_auth'
        db.add_column('challenge_mgr_challengesettings', 'use_internal_auth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChallengeSettings.use_cas_auth'
        db.delete_column('challenge_mgr_challengesettings', 'use_cas_auth')

        # Deleting field 'ChallengeSettings.use_ldap_auth'
        db.delete_column('challenge_mgr_challengesettings', 'use_ldap_auth')

        # Deleting field 'ChallengeSettings.use_internal_auth'
        db.delete_column('challenge_mgr_challengesettings', 'use_internal_auth')
    ...
    models = {
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 19, 13, 28, 36, 317548)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 12, 13, 28, 36, 317494)'})
        },
