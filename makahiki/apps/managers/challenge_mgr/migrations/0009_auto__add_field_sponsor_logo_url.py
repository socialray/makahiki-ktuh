...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sponsor.logo_url'
        db.add_column('challenge_mgr_sponsor', 'logo_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sponsor.logo_url'
        db.delete_column('challenge_mgr_sponsor', 'logo_url')
    ...
    models = {
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 15, 33, 50, 355184)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 3, 15, 33, 50, 355129)'})
        },
