...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChallengeSetting.site_name'
        db.delete_column('challenge_mgr_challengesetting', 'site_name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ChallengeSetting.site_name'
        db.add_column('challenge_mgr_challengesetting', 'site_name', self.gf('django.db.models.fields.CharField')(default='My site', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 7, 51, 20, 282975)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 7, 51, 20, 282947)'})
        },
