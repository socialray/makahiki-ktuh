...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChallengeSettings.wattdepot_server_url'
        db.add_column('challenge_mgr_challengesettings', 'wattdepot_server_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChallengeSettings.wattdepot_server_url'
        db.delete_column('challenge_mgr_challengesettings', 'wattdepot_server_url')
    ...
    models = {
        ...
        'challenge_mgr.roundsettings': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 16, 10, 33, 45, 818194)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Round 1'", 'max_length': '50'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 9, 10, 33, 45, 818133)'})
        },
