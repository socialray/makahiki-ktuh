...
from widgets.smartgrid.models import Activity, Commitment, ActivityMember, CommitmentMember
from widgets.smartgrid import get_current_commitments, get_available_activities
