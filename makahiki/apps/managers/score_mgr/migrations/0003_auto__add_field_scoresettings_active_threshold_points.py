...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoreSettings.active_threshold_points'
        db.add_column('score_mgr_scoresettings', 'active_threshold_points', self.gf('django.db.models.fields.IntegerField')(default=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoreSettings.active_threshold_points'
        db.delete_column('score_mgr_scoresettings', 'active_threshold_points')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 22, 15, 7, 253070)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 22, 15, 7, 252890)'}),
