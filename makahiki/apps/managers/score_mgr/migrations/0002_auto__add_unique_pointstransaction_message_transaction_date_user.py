...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PointsTransaction', fields ['message', 'transaction_date', 'user']
        db.create_unique('score_mgr_pointstransaction', ['message', 'transaction_date', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PointsTransaction', fields ['message', 'transaction_date', 'user']
        db.delete_unique('score_mgr_pointstransaction', ['message', 'transaction_date', 'user_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 11, 12, 24, 965107)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 11, 12, 24, 964926)'}),
