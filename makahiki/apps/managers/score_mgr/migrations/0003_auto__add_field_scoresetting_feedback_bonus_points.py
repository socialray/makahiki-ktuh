...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoreSetting.feedback_bonus_points'
        db.add_column('score_mgr_scoresetting', 'feedback_bonus_points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoreSetting.feedback_bonus_points'
        db.delete_column('score_mgr_scoresetting', 'feedback_bonus_points')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 17, 12, 41, 22, 353512)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 17, 12, 41, 22, 353354)'}),
