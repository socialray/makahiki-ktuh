...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('score_mgr_scoresetting', (
        ...
        db.send_create_signal('score_mgr', ['ScoreSetting'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('score_mgr_scoresetting')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 15, 23, 11, 45, 326858)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 15, 23, 11, 45, 326682)'}),
