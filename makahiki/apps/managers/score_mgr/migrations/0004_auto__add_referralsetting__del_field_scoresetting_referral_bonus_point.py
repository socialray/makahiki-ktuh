...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('score_mgr_referralsetting', (
        ...
        db.send_create_signal('score_mgr', ['ReferralSetting'])

        # Deleting field 'ScoreSetting.referral_bonus_points'
        db.delete_column('score_mgr_scoresetting', 'referral_bonus_points')


    def backwards(self, orm):
        
        # Deleting model 'ReferralSetting'
        db.delete_table('score_mgr_referralsetting')

        # Adding field 'ScoreSetting.referral_bonus_points'
        db.add_column('score_mgr_scoresetting', 'referral_bonus_points', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 23, 8, 36, 772568)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 23, 8, 36, 772383)'}),
