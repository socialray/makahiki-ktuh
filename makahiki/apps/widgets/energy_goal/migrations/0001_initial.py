...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('energy_goal_energygoal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team_mgr.Team'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('goal_status', self.gf('django.db.models.fields.CharField')(default='Not available', max_length=20)),
        ))
        db.send_create_signal('energy_goal', ['EnergyGoal'])

        # Adding model 'EnergyGoalSettings'
        db.create_table('energy_goal_energygoalsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team_mgr.Team'])),
        ...
        db.send_create_signal('energy_goal', ['EnergyGoalSettings'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('energy_goal_energygoal')

        # Deleting model 'EnergyGoalSettings'
        db.delete_table('energy_goal_energygoalsettings')
    ...
    models = {
        ...
        'energy_goal.energygoalbaseline': {
            'Meta': {'object_name': 'EnergyGoalBaseline'},
