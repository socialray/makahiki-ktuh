...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_noticetemplate', (
        ...
        db.send_create_signal('notifications', ['NoticeTemplate'])

        # Adding model 'UserNotification'
        db.create_table('notifications_usernotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('notifications', ['UserNotification'])


    def backwards(self, orm):
        
        # Deleting model 'NoticeTemplate'
        db.delete_table('notifications_noticetemplate')

        # Deleting model 'UserNotification'
        db.delete_table('notifications_usernotification')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 1, 19, 28, 159657)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 1, 19, 28, 159485)'}),
