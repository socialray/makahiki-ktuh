...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BadgeAward.user'
        db.delete_column('badges_badgeaward', 'user_id')

        # Adding field 'BadgeAward.profile'
        db.add_column('badges_badgeaward', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['player_mgr.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BadgeAward.user'
        db.add_column('badges_badgeaward', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']), keep_default=False)

        # Deleting field 'BadgeAward.profile'
        db.delete_column('badges_badgeaward', 'profile_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 18, 18, 50, 41, 389311)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 18, 18, 50, 41, 389155)'}),
