...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.award_trigger'
        db.add_column('badges_badge', 'award_trigger', self.gf('django.db.models.fields.CharField')(default='daily', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.award_trigger'
        db.delete_column('badges_badge', 'award_trigger')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 14, 49, 34, 873823)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 14, 49, 34, 873639)'}),
