...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('participation_teamparticipation', 'round_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeamParticipation.round_name'
        db.delete_column('participation_teamparticipation', 'round_name')
