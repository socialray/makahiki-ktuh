...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('smartgrid_bonuspoints', (
        ...
        db.send_create_signal('smartgrid', ['BonusPoints'])


    def backwards(self, orm):
        
        # Deleting model 'BonusPoints'
        db.delete_table('smartgrid_bonuspoints')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 11, 36, 11, 563702)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 11, 36, 11, 563547)'}),
