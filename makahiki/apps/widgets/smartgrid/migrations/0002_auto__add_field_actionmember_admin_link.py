...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionMember.admin_link'
        db.add_column('smartgrid_actionmember', 'admin_link', self.gf('django.db.models.fields.URLField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActionMember.admin_link'
        db.delete_column('smartgrid_actionmember', 'admin_link')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 15, 49, 19, 317083)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 15, 49, 19, 316946)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 6, 12)'}),
        ...
        'smartgrid.actionmember': {
            ...
            'admin_link': ('django.db.models.fields.URLField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
