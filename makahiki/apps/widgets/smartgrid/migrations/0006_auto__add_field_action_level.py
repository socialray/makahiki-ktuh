...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('smartgrid_action', 'level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.level'
        db.delete_column('smartgrid_action', 'level')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 14, 43, 38, 71047)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 14, 43, 38, 70869)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 6, 5)'}),
