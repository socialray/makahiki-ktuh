...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConfirmationCode.user'
        db.add_column('smartgrid_confirmationcode', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'ConfirmationCode.create_date'
        db.add_column('smartgrid_confirmationcode', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 12, 15, 10, 0, 813483)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConfirmationCode.user'
        db.delete_column('smartgrid_confirmationcode', 'user_id')

        # Deleting field 'ConfirmationCode.create_date'
        db.delete_column('smartgrid_confirmationcode', 'create_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 10, 1, 534559)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 10, 1, 534374)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 12)'}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 10, 0, 813483)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
