...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BonusPoints.value'
        db.delete_column('smartgrid_bonuspoints', 'value')

        # Adding field 'BonusPoints.point_value'
        db.add_column('smartgrid_bonuspoints', 'point_value', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BonusPoints.value'
        db.add_column('smartgrid_bonuspoints', 'value', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Deleting field 'BonusPoints.point_value'
        db.delete_column('smartgrid_bonuspoints', 'point_value')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 13, 16, 53, 540129)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 13, 16, 53, 539920)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 4)'}),
