...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionMember.admin_link'
        db.alter_column('smartgrid_actionmember', 'admin_link', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ActionMember.admin_link'
        db.alter_column('smartgrid_actionmember', 'admin_link', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 1, 6, 24, 830424)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 1, 6, 24, 830236)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 2)'}),
