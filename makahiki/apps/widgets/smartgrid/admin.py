...
class ActivityAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.created_at and self.instance.confirm_type == "code":
            ...
            self.fields["num_codes"].help_text += reverse("apps.widgets.smartgrid.views.view_codes",
        ...
        self.instance.type == "event" or self.instance.type == "excursion"):
            url = reverse("apps.widgets.smartgrid.views.view_rsvps",
                args=(self.instance.type, self.instance.slug,))
            self.fields[
...
class ActivityMemberAdminForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if status == "approved" and activity.has_variable_points:
            ...
            elif cleaned_data["points_awarded"] < activity.point_range_start or \
                 cleaned_data["points_awarded"] > activity.point_range_end:
...
class ActivityMemberAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        """Override to remove the points_awarded field if the activity
