...
class ActivityAdminForm(forms.ModelForm):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if self.instance and self.instance.created_at and self.instance.confirm_type == "code":
      ...
      self.fields["num_codes"].help_text += reverse("widgets.smartgrid.views.view_codes", args=(self.instance.type, self.instance.slug,))
    ...
    if self.instance and self.instance.created_at and (self.instance.type == "event" or self.instance.type == "excursion"):
      url = reverse("widgets.smartgrid.views.view_rsvps", args=(self.instance.type, self.instance.slug,))
