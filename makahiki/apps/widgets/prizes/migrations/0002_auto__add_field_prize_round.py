...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prize.round'
        db.add_column('prizes_prize', 'round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenge_mgr.RoundSetting'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prize.round'
        db.delete_column('prizes_prize', 'round_id')
    ...
    models = {
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 8, 14, 24, 8, 479142)'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 14, 24, 8, 479075)'})
        },
        'prizes.prize': {
            'Meta': {'ordering': "('round_name', 'award_to', 'competition_type')", 'unique_together': "(('round_name', 'award_to', 'competition_type'),)", 'object_name': 'Prize'},
