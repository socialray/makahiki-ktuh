...
challenge_mgr.register_game_admin_model("resource_goal.energy", EnergyBaselineDaily)
challenge_mgr.register_game_admin_model("resource_goal.energy", EnergyBaselineHourly)
