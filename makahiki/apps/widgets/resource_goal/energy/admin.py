...
challenge_mgr.register_game_admin_model("Energy Game", EnergyGoal)
challenge_mgr.register_game_admin_model("Energy Game", EnergyBaselineDaily)
challenge_mgr.register_game_admin_model("Energy Game", EnergyBaselineHourly)
