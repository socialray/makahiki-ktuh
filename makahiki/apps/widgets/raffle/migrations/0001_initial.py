...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('raffle_raffleprize', (
        ...
        db.send_create_signal('raffle', ['RafflePrize'])

        # Adding model 'RaffleTicket'
        db.create_table('raffle_raffleticket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('raffle', ['RaffleTicket'])


    def backwards(self, orm):
        
        # Deleting model 'RafflePrize'
        db.delete_table('raffle_raffleprize')

        # Deleting model 'RaffleTicket'
        db.delete_table('raffle_raffleticket')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 1, 20, 6, 516678)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 1, 20, 6, 516505)'}),
