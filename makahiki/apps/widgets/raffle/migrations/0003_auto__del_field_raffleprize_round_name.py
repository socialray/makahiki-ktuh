...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RafflePrize.round_name'
        db.delete_column('raffle_raffleprize', 'round_name')


    def backwards(self, orm):
        
        # Adding field 'RafflePrize.round_name'
        db.add_column('raffle_raffleprize', 'round_name', self.gf('django.db.models.fields.CharField')(default='foo', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 12, 38, 27, 950879)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 12, 38, 27, 950637)'}),
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 12, 37, 54, 762380)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 12, 37, 54, 762313)'})
        },
