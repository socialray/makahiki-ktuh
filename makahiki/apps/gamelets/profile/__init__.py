...
from gamelets.smartgrid_game import get_current_activity_members, get_current_commitment_members
from gamelets.smartgrid_game.models import ActivityMember
