...
class QuestConditionsTest(TestCase):
  ...
  def testBadgeAwarded(self):
    ...
    from gamelets.badges.user_badges import DailyVisitorBadge
  ...
  def testPostedToWall(self):
    ...
    """
    from services.team_mgr.models import Dorm, Floor, Post
    from gamelets.quests import posted_to_wall
