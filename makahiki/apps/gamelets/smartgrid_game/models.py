...
from gamelets.badges import user_badges
from lib.brabeion import badges

from services.team_mgr.models import Post
from services.base_mgr.models import Like
from gamelets.notifications.models import UserNotification
from services.cache_mgr.utils import invalidate_floor_avatar_cache, invalidate_commitments_cache
...
def activity_image_file_path(instance=None, filename=None, user=None):
  ...
  from gamelets.smartgrid_game import ACTIVITY_FILE_DIR
